<?php 
    ...
    if(isset($_POST['upd_contacts'])) {
        ...
        $q = "UPDATE `contact_details` SET `address`=?,`gmap`=?,`phone`=?,`email`=?,`iframe`=? WHERE `sr_no`=?";
        $values = [$frm_data['address'], $frm_data['gmap'], $frm_data['phone'], $frm_data['email'], $frm_data['iframe'],1];
