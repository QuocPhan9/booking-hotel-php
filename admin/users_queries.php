                ...
                <div class="card border-0 shadow-sm mb-4">
                    <div class="card-body">
                        ...
                        <div class="text-end mb-4">
                            <a href="?seen=all" class="btn btn-primary rounded-pill shadow-none btn-sm"><i class="bi bi-check-all"></i> Mark all read</a>
                                ...
                                <tbody>
                                    <?php 
                                        ...
                                        while($row = mysqli_fetch_assoc($data)) {
                                            $seen = '';
                                            if($row['seen'] != 1){
                                                $seen = "<a href='?seen=$row[sr_no]' class='btn btn-sm rounded-pill btn-secondary'>Mark as read</a>";
                                            }
